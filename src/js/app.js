//to make this work wrap the 'build' version (browseryfied, babelyfied etc. in gulp)
//in function getAreas() {...}, which gets called in the google map script tag in the html
const myJson = [];
